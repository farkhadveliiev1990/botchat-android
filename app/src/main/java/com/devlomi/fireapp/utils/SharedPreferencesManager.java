...
public class SharedPreferencesManager {
    ...
    // save post list
    public static void savePostListJsonString( String postListJsonString ) {
        mPostPref.edit().putString("posts", postListJsonString).apply();
    }

    public static String getPostListJsonString() {
    ...
    public static String getGender() { return mSharedPref.getString("gender", ""); }

    public static String getLanguage() { return mSharedPref.getString("lang", "");}
